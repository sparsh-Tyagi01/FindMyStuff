    ...
    <div className='w-screen h-screen bg-blue-200 flex flex-col justify-center items-center'>
      ...
      <div className="w-[85vw] md:w-[40vw] h-[80vh] bg-blue-100 rounded-[8px] flex flex-col items-center shadow-xl">
        ...
        <form className="flex flex-col mt-8 w-[80vw] md:w-[35vw]">
          ...
          <input id="name" name="name" type="text" placeholder="Enter your name" className="focus:outline-none bg-blue-200 rounded-[5px] py-1 px-2 mb-2 border-1 border-gray-400"/>
        ...
        <p>Already have an account? <h4 className="inline-block text-blue-600 font-bold mt-4 cursor-pointer">Sign In</h4></p>
      </div>
    </div>
  )
}
